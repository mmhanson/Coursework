// Formula Evaluator for the formula class
// by Maxwell Hanson (u0985911)
// originally built for CS 3500 project 1, retrofitted to deal with Doubles and not ints for CS 3500 project 3
    ...
    public static class Evaluator
    {
        ...
        public static Double Evaluate(String exp, Func<String, Double> variableEvaluator)
        {
            ...
            if (operatorStack.Count() == 0)
            {
                ...
                return Double.Parse(operandStack.Pop());
            }
            else
            {
        ...
        private static void processToken(String token, Stack<String> operatorStack, Stack<String> operandStack, Func<String, Double> variableEvaluator)
        {
            // skip empty tokens
            ...
            if (isRightParenthesis(token))
            {
                ...
                // next, top f stack shoudl be (, pop it
                String poppedStr = popOrEmptyString(operatorStack);
                if (!poppedStr.Equals("("))
                {
        ...
        {
            return Double.TryParse(token, out double placeholder);
        }

...
/**
 * Testing suite for the "QuadProbeHashTable" class.
 * 
 * @author Max Hanson
 * @since 3/27/18
 * @version 1.0.0
...
public class QuadProbeHashTableTests {
	 ...
	 */
	private QuadProbeHashTable emptySet;
	/**
	 ...
	 */
	private QuadProbeHashTable oneSet;
	/**
	 ...
	 */
	private QuadProbeHashTable manySet;
	/**
	...
	public void setup() {
		...
		// create hash tables
		emptySet = new QuadProbeHashTable(initCap, hasher);
		oneSet = new QuadProbeHashTable(initCap, hasher);
		for (String elem: oneSetElems) {
			oneSet.add(elem);
		}
		manySet = new QuadProbeHashTable(initCap, hasher);
	...
	public void testConstructor() {
		QuadProbeHashTable newSet = new QuadProbeHashTable(initCap, hasher);
		...
		newSet = new QuadProbeHashTable(0, hasher);
		
		try {
			newSet = new QuadProbeHashTable(-5, hasher);
		}
		catch (NegativeArraySizeException e) {}
		
		try {
			QuadProbeHashTable qpht = new QuadProbeHashTable(1, null);
			qpht.add("abc");
			fail("");
		}
